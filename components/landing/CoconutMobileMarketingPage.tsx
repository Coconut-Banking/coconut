...
import { ThemeCtx, THEMES } from "./theme-context";
import type { Theme } from "./theme-context";

// Lazy-load the Splitwise import demo screen — it is only shown when the user
// explicitly clicks "Import from Splitwise" and is never visible on first load.
const SplitwiseScreen = dynamic(() => import("./SplitwiseScreen"), { ssr: false });
...
// SplitwiseScreen is lazy-loaded via next/dynamic (see top of file).
// Implementation lives in ./SplitwiseScreen.tsx.
