...
<script>
  // Try deep link first, then close the tab
  var scheme = /coconut-dev/.test(document.referrer) ? "coconut-dev" : "coconut";
  window.location.href = scheme + "://settings?stripe_connect=complete";
