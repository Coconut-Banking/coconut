...
const SpendingChart = dynamic(
  ...
  { ssr: false, loading: () => <div className="h-40 flex items-center justify-center text-sm text-gray-400">Loading chart...</div> }
);
      ...
      <div className="grid grid-cols-5 gap-4 mb-6">
        <div className="col-span-3 bg-white rounded-2xl border border-gray-100 p-5">
          ...
          {spendingData.length > 0 ? (
            <SpendingChart data={spendingData} currencyCode={currencyCode} />
          ) : (
